...
class Woo_Sidebars {
	...
	public function register_custom_column_headings( $defaults ) {
		...
		$new_columns = array(
			'sidebar_to_replace' => __( 'Sidebar To Replace', 'woosidebars' ),
			'condition'          => __( 'Condition(s)', 'woosidebars' )
		);
	...
	public function description_meta_box( $post ) {
		?>
		<label class="screen-reader-text" for="excerpt"><?php _e( 'Description', 'woosidebars' ); ?></label><textarea
			rows="1" cols="40" name="excerpt" tabindex="6"
	...
	public function enable_custom_post_sidebars() {
		...
		if ( ! current_user_can( 'edit_posts' ) ) {
			wp_die( __( 'You do not have sufficient permissions to access this page.', 'woosidebars' ) );
		}
		if ( ! check_admin_referer( 'woosidebars-post-enable' ) ) {
